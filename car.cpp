...
line(560,142,569,142);line(569,142,582,102);
line(582,102,620,92);
...
line(280,180,320,185);line(320,185,363,127);
////////////////////////////////sidemirror
...
ellipse(238,249,227,250,200,60);/////////////wheel1
...
line(190+449,57+c,190+449,71+c);c=236;
...
line(190+210,156+c-42,190+210,170+c-42);line(190+240,156+c-48,190+240,170+c-48);
...
/////////////////////////////1
line(1,310,25,306);
line(6,318,30,315);line(1,310,6,318);
line(25,306,30,314);
int k,m;
k=13*45+19;
m=16*(-8);
...
setfillstyle(1,14);
floodfill(14,314,12);
floodfill(617,183,12);setfillstyle(1,0);
floodfill(14,314,12);
...
floodfill(294,295,13);floodfill(274,265,13);
...
floodfill(200,250,13);
delay(10);
//setfillstyle(1,11);floodfill(170,250,13);
floodfill(80,230,13);
}
if(t=='l')
{
...
floodfill(548,214,13);
floodfill(533,228,13);
floodfill(563,228,13);floodfill(262,281,13);
floodfill(308,281,13);
floodfill(284,251,13);
floodfill(284,295,13);
////////////////////////////////////////road
...
setfillstyle(1,14);
floodfill(64,303,12);
setfillstyle(9,4);floodfill(302+248,230,13);
floodfill(302+248+v,230+b,13);
delay(20);
setfillstyle(1,14);
floodfill(200,250,13);
...
outtextxy(10,10,"L-LIGHTS");
outtextxy(10,20,"H-HORN");//outtextxy(10,30,"T-AllOY");
}
}
circle(300,100,3);
nosound();
...
bitmap_output(-0.85,0.50,0.50,"'ANIMATED 3D CAR'");
glutSwapBuffers();
glFlush();
}